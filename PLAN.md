...
5. **The mention format for channel replies.** Other clients seem to write `@[Sender]:`; confirm against the MeshCore app and MeshMonitor before 5f builds on it. (2026-09-21.)
